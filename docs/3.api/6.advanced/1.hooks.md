...
`page:start`           | `pageComponent?`    | 客户端             | 在 [Suspense](https://vue.zhcndoc.com/guide/built-ins/suspense.html#suspense) 待定事件时调用。
`page:finish`          | `pageComponent?`    | 客户端             | 在 [Suspense](https://vue.zhcndoc.com/guide/built-ins/suspense.html#suspense) 解决事件时调用。
