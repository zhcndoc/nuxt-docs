...
::warning
`abortNavigation` 仅可在[路由中间件处理程序](/docs/4.x/guide/directory-structure/app/middleware)内使用。
::
...
你可以将错误作为一个 [`Error`](https://developer.mozilla.org/pl/docs/Web/JavaScript/Reference/Global_Objects/Error) 对象传递，例如在 `catch` 块中捕获到的错误：
