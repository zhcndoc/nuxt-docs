...
为了简化升级流程，我们与 [Codemod](https://github.com/codemod-com/codemod) 团队合作，提供了多个开源的自动化迁移脚本。

::note
如果遇到任何问题，请使用 `npx codemod feedback` 向 Codemod 团队反馈 🙏
::

关于 Nuxt 4 Codemods 的完整列表、详细信息、源码及多种运行方式，请访问 [Codemod 注册表](https://go.codemod.com/codemod-registry)。
...
最后，直接在 Nuxt 内置代码序列化函数不理想。更推荐使用如 [unjs/knitwork](http://github.com/unjs/knitwork) 这类项目，它们可以作为你的项目依赖，在那里可以直接上报和修复安全问题，无需更新 Nuxt。
