...
::tip
你可以通过设置 `future.compatibilityVersion: 5` 提前测试此功能（参见 [Testing Nuxt 5](/docs/4.x/getting-started/upgrade#testing-nuxt-5)），或者通过显式启用 `experimental.typedPages: true` 来开启它。
::
