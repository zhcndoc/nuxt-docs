...
* 如果您使用 [模板参数](https://unhead.unjs.io/docs/head/guides/plugins/template-params) 或 [别名标签排序](https://unhead.unjs.io/docs/head/guides/plugins/alias-sorting)，您现在需要明确选择加入这些功能。
