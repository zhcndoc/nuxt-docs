...
如果您需要在预处理文件中注入代码，比如带有颜色变量的 [Sass partial](https://sass-lang.com/documentation/at-rules/use#partials)，可以通过 Vite 的 [preprocessorOptions](https://vite.zhcndoc.com/config/shared-options.html#css-preprocessoroptions) 实现。
...
Vite 提供了一个 [实验性选项](https://vite.zhcndoc.com/config/shared-options.html#css-preprocessormaxworkers) ，可加速使用预处理器。
...
您可以参考 [Vue 文档](https://vue.zhcndoc.com/api/sfc-css-features.html) 获取关于 SFC 组件样式的完整参考。
...
详情请参考 [Vue 文档](https://vue.zhcndoc.com/guide/essentials/class-and-style.html)。
