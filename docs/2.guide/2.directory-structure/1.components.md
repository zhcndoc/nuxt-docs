...
::note
在底层，它使用 Vue 的内置 [`hydrateOnVisible` 策略](https://vue.zhcndoc.com/guide/components/async.html#hydrate-on-visible)。
::
...
::note
在底层，它使用 Vue 的内置 [`hydrateOnIdle` 策略](https://vue.zhcndoc.com/guide/components/async.html#hydrate-on-idle)。
::
...
::note
在底层，它使用 Vue 的内置 [`hydrateOnInteraction` 策略](https://vue.zhcndoc.com/guide/components/async.html#hydrate-on-interaction)。
::
...
::note
在底层，它使用 Vue 的内置 [`hydrateOnMediaQuery` 策略](https://vue.zhcndoc.com/guide/components/async.html#hydrate-on-media-query)。
::
