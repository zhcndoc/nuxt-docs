...
:read-more{title="懒加载组件" to="/docs/4.x/guide/directory-structure/app/components#dynamic-imports"}
...
:read-more{title="延迟水合" to="/docs/4.x/guide/directory-structure/app/components#delayed-or-lazy-hydration"}
