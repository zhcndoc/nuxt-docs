...
要将配置和环境变量暴露给应用的其他部分，需要在你的 [`nuxt.config`](/docs/4.x/guide/directory-structure/nuxt-config) 文件中使用 [`runtimeConfig`](/docs/4.x/api/nuxt-config#runtimeconfig) 选项来定义运行时配置。
