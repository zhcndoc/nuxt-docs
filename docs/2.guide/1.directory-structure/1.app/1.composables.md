...
你可以从 composables 中访问 [插件注入](/docs/4.x/guide/directory-structure/plugins#providing-helpers)：
...
Nuxt 只扫描位于 [`app/composables/` 目录](/docs/4.x/guide/directory-structure/app/composables) 顶层的文件，例如：
