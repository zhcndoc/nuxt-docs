---
title: Nuxt MCP 服务器
description: 在您的 AI 助手中使用带有模型上下文协议支持的 Nuxt 文档。
...
::note{icon="i-lucide-info"}
**请确保已安装 Claude Code** — 访问 [Anthropic 文档](https://docs.claude.com/en/docs/claude-code/quickstart) 获取安装说明。
::
...
::note{icon="i-lucide-info"}
**请安装必要的扩展** — 确保已安装 [GitHub Copilot](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot) 和 [GitHub Copilot Chat](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot-chat) 扩展。
::
...
更多关于使用 MCP 扩展 GitHub Copilot 编码代理的信息，请参阅 [使用 MCP 扩展编码代理](https://docs.github.com/en/copilot/how-tos/use-copilot-agents/coding-agent/extend-coding-agent-with-mcp)。
