...
::note
我们建议将你层中的内容作为 npm 包（公开或私有，例如通过 [GitHub Packages](https://docs.github.com/en/packages/learn-github-packages/introduction-to-github-packages)）发布，而不是依赖远程层。

另外，你也可以直接将一个 [远程 git URL 作为依赖项](https://docs.npmjs.com/cli/v11/configuring-npm/package-json#git-urls-as-dependencies) 添加。
::
...
## 禁用来自层的模块 :badge[v4.3]{color="info" size="xs" class="align-middle"}
