...
- “本地”模块，它们存在于 Nuxt 项目本身中，或者[内联在 Nuxt 配置中](/docs/4.x/api/nuxt-config#modules)，或者作为[ `modules` 目录的一部分](/docs/4.x/directory-structure/modules)。
...
有多种方法可以从你的模块扩展用户项目的 TypeScript 配置。
