...
插件现在只接受一个参数（`nuxtApp`）。你可以在[文档](/docs/4.x/guide/directory-structure/plugins)中了解更多。
...
中间件现在只接受两个参数（`to`、`from`）。你可以在[文档](/docs/4.x/guide/directory-structure/app/middleware)中了解更多。
