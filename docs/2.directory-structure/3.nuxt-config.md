...
为确保你的配置是最新的，Nuxt 在检测到主配置文件、[`.env`](/docs/4.x/directory-structure/env)、[`.nuxtignore`](/docs/4.x/directory-structure/nuxtignore) 和 [`.nuxtrc`](/docs/4.x/directory-structure/nuxtrc) 点文件发生更改时会进行完整重启。
