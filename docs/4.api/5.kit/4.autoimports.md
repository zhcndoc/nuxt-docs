...
向 Nuxt 应用添加导入。它会使你的导入在 Nuxt 应用上下文中可用，无需手动导入。

::tip
如需添加 Nitro 服务器上下文的导入，请参考 [`addServerImports`](/docs/3.x/api/kit/nitro#addserverimports) 函数。
::
...
|-----------|---------------------------------------------|----------|------------------------------------------------------------------------------------------------|
| `from`    | `string`                                    | `true`   | 要从中导入的模块说明符（specifier）。                                                               |
