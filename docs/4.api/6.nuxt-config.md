...
**See**: [Vue KeepAlive](https://vue.zhcndoc.com/api/built-in-components#keepalive)
...
**See**: [Vue Transition docs](https://vue.zhcndoc.com/api/built-in-components#transition)
...
**See**: [Vue documentation](https://vue.zhcndoc.com/api/application#app-config-compileroptions)
...
**See**: [Vue app config documentation](https://vue.zhcndoc.com/api/application#app-config)
