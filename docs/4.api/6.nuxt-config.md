...
**See**: [Nuxt 文档](/docs/4.x/directory-structure/app/composables)
...
**See**: [`app/plugins/` 目录文档](/docs/4.x/directory-structure/app/plugins)
...
**See**: [`server/` 目录文档](/docs/4.x/directory-structure/server)
...
你可以使用此选项扩展生成的 `.nuxt/tsconfig.app.json` TypeScript 配置。
